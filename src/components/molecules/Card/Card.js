...
<InnerWrapper activeColor={cardType}>
        ...
        {cardType === 'article' && <StyledAvatar src={Avatar1}/>}
        {cardType === 'ideas' && <StyledBulbButton href='/'/>}
    </InnerWrapper>
    <InnerWrapper flex>
        <Paragraph>Lorem ipsum dolor sit amet consectetur adipisicing elit. Obcaecati quos aliquid iste nulla, suscipit molestias eos ea est porro nihil eveniet laudantium. Natus exercitationem ex asperiores numquam ea, illo voluptates?</Paragraph>
...
Card.propTypes = {
    cardType: PropTypes.oneOf(['note','ideas','article']),
}
Card.defaultProps = {
    cardType:'ideas',
}
